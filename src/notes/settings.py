...
SECRET_KEY = os.environ.get("SECRET_KEY", "django-insecure-5_3#=j(gos_lzzf++bwdm8ycnxhpr&mvydh96ie8hd^t+$gd23")
...
# DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", "from@example.com")
